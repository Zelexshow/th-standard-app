package com.bytepound.thstandapp.application.service.impl;

import com.bytepound.thstandapp.application.rsp.UserLoginTokenVO;
import com.bytepound.thstandapp.application.rsp.UserLoginVO;
import com.bytepound.thstandapp.application.service.LoginService;
import com.bytepound.thstandapp.common.constant.ErrorCode;
import com.bytepound.thstandapp.common.constant.ExtInfoConstant;
import com.bytepound.thstandapp.common.constant.LoginType;
import com.bytepound.thstandapp.common.model.login.IpLocationInfo;
import com.bytepound.thstandapp.common.model.login.JWTPayload;
import com.bytepound.thstandapp.common.model.login.JWTUtils;
...
import com.bytepound.thstandapp.common.util.DBUtils;
import com.bytepound.thstandapp.common.util.IDGenerator;
import com.bytepound.thstandapp.common.util.SnowFlakeIDGenerator;
...
public class DefaultLoginServiceImpl implements LoginService {
    ...
    public UserLoginVO getUserLoginVOPayload(String token, String secret) {
        String objStr;
        try {
            objStr = JWTUtils.verifyTokenByHMAC(token, secret);
